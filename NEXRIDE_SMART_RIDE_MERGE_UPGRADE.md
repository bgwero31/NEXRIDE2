# NEXRIDE NEXRIDE Smart Ride Merge Upgrade

This version changes NEXRIDE into a map-first ride app direction:

- premium live login animation with NEXRIDE blue/black gradient branding.
...
- Rider request flow is smart fare: pickup, destination, custom fare, payment, ride style, notes.
...
Important: this is a premium no-map-library prototype. It gives the premium ride-hailing feeling without adding Google Maps or Mapbox dependencies. Real turn-by-turn navigation can be added later with Google Maps/Mapbox APIs.
